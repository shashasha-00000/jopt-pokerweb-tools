...
确认最终版本后，再复制到 Google Drive。

### 同时存在源码和交付版时

如果同一个项目同时有开发源码和最终交付版：

* 源码 → Git 本地仓库 / GitHub
* 最终导出或交付版 → Google Drive

不要把整个开发项目复制到 Google Drive。
