...
const PRE_RES_CONFIG = {
  ...
  eventNameOverride: 'SPADIE season 42nd / #47 NLH Team Battle -3on3-',
  eventKeyOverride: 'NLH Team Battle -3on3-',
  livePocketUrl: '',
  events: {
    'Open Face Chinese Poker': {
      ...
      receptionNote: '・当日はご予約者ご本人様のみ受付をされてください。'
    },
...
お申し込みいただいておりました事前予約につきまして、
お支払い期限までにご入金の確認ができなかったため、
誠に恐れ入りますが、お申し込みは自動キャンセルとなりました。
