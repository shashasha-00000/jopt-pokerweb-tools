...
const PRE_RES_CONFIG = {
  ...
  eventNameOverride: 'SPADIE TOKYO 42nd / NLH Heads-up Knockout - 3on3 -',
  eventKeyOverride: 'NLH Heads-up Knockout - 3on3 -',
  livePocketUrl: '',
  events: {
...
　受付終了：{{RECEPTION_CLOSE}}
・当日お支払い金額：ドリンク代 {{DAY_OF_PAYMENT_AMOUNT}}円
