...
| `pw-existing-item-fee-patch.user.js` | PW Existing Tournament Patch | Existing tournament name and item fee patch | Minimal TSV patch tool. Uses pasted URL/TournamentId or resolves open tournaments, then updates only the listed name and/or item fee fields. |
