...
function preResMailerBuildReport_(mailTypeFilter, reportLabel) {
  ...
  const rows = preResMailerReadSourceRows_(ctx.sourceSheet, ctx.sourceMap, reportGeneratedAt);
...
function preResMailerReadSourceRows_(sheet, map, deadlineBaseTime) {
  const source = preResMailerReadSourceRowsWithoutUpdates_(sheet, map, deadlineBaseTime);
